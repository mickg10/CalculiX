...
static void tt_build_wl(TtSpmvCtx* K) {
    ...
    MakeCB(program, all_set, tt::CBIndex::c_0, 9); MakeCB(program, all_set, tt::CBIndex::c_1, 9);  // depth 9 = one offset-group (3 k's x 3 planes); reader pushes 9, compute drains 3/k FIFO
