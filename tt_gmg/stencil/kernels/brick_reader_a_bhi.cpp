// Stream all three A splits while materializing only the high x split.
// A companion RISC-1 kernel materializes the middle x split so the scalar
// halo work is shared across both data-movement processors.
