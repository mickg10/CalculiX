// Run52 arithmetic with A-hi/A-mid and A-low supplied by separate readers.
// All face/edge/center offsets retain x-low.  The inversion-symmetric corner
// pair 6/20 also retains x-low; the other corners use the proven T5 order.
                ...
                if (stream_term < accumulate_terms) {
                    ...
                    for (uint32_t output_component = 0;
                        ...
                        if (retain_low) {
                            ...
                            // Preserve run52's five-product T5 order.
                            mac_term<ckernel::MathFidelity::HiFi4>(
                                cb_a_low, cb_bhi, a_low, batch_lane,
                                output_component, false);
                            mac_term<ckernel::MathFidelity::HiFi4>(
