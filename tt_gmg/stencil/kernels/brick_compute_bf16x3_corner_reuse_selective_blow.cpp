// Run52 arithmetic with exact corner representatives in the normal A CB.
// The reader keeps the fixed 27-page cadence, placing the nine shared corner
// tiles in pages 0..8 and leaving the unused padding pages untouched.
