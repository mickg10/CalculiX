...
/* Stash CalculiX's in-memory coord/DOF map (co, nactdof, nk, mi) right before the static solve so the GMG
   path can reconstruct the voxel grid without a file. Fortran-style trailing-underscore symbol. */
